...
p2=Point(110,0)
r=Rectangle(p1,p2)
print(r.upperleft.y, r.lowerright.y)
#r.draw()
#r.move(10,20)
#print(r.upperleft.y, r.lowerright.y)
p3=Point(50, 20)
p4=Point(80, 0)
other=Rectangle(p3, p4)
print(r.overlaps(other))
n=r.intersection(other)
print(n.upperleft.x, n.upperleft.y)
print(n.lowerright.x, n.lowerright.y)'''
class Line:
